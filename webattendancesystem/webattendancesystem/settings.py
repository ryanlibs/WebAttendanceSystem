"""
Django settings for webattendancesystem project.
...
INSTALLED_APPS = [
    ...
    'webapp.apps.WebappConfig',  # Make sure this is here
]
...
ROOT_URLCONF = 'webattendancesystem.urls'
...
WSGI_APPLICATION = 'webattendancesystem.wsgi.application'
